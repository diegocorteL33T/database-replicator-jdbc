...
public class TelaReplicacaoProcesoTabelaView extends JFrame {
    ...
    public TelaReplicacaoProcesoTabelaView() {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(()-> new TelaReplicacaoProcesoTabelaView().setVisible(true));
    }
}
